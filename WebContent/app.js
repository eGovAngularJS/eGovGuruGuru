...
angular.module('egovNgDashboard', ['egov.ui']).
    ...
    // 	var period = [];
    // 	for (var j = 11; j >= 0; j--) {
    // 		period.push(Math.round(Math.random() * 10));
	   //  };
    ...
    $scope.searchData = function(){
        ...
        // 기간에 따른 방문자 수
        $http.post('visit/retrieveVisitInfo.do', params, headers).
        ...
        // 지역별 방문자 수
        $http.post('visit/retrieveAreaInfo.do', params, headers).
        success(function(data, status, headers, config){
            // console.log("2",data);
        ...
        // 나이별 방문자 수
        $http.post('visit/retrieveAgeInfo.do', params, headers).
        success(function(data, status, headers, config){
            console.log("3",data);
            $scope.dAge = [
  	            {key: "10이하", y: data.a0},
        ...
        // 성별 방문자 수
        $http.post('visit/retrieveGenderInfo.do', params, headers).
        success(function(data, status, headers, config){
            console.log("4",data);
            $scope.dSex = [
